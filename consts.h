...
#define RDIV 10000                      /* grid point in RK integration */
...
#define G 6.6743e-8                     /* gravitational constant */
#define HBAR_CGS 1.054571817e-27        /* reduced Planck's constant in cgs units */
#define KAPPA (1.0e-15*C*C/G)           /* scaling factor */
#define KSCALE (KAPPA*G/(C*C*C*C))      /* another scaling factor */
#define HBAR (HBAR_CGS*G/(KAPPA*C*C*C)) /* reduced Planck's constant in dimensionless units */
